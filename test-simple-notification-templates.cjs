// ============================================
// SIMPLE NOTIFICATION TEMPLATE TEST (CommonJS)
...
// Test 2: Import Templates (CommonJS)
console.log('📝 Step 2: Loading Notification Templates...');

try {
  const NotificationTemplates = require('./src/server/services/NotificationTemplates');
