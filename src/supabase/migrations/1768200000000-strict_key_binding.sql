-- FINAL ENFORCEMENT: Update use_enrollment_key and add a database trigger
-- This ensures that NO MATTER HOW a student is enrolled, if they use a key, it MUST match the course.
