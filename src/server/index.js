...
import customPrepRoutes from './routes/customPrep.js';
import enrollmentRoutes from './routes/enrollment.js';
import invitationsRoutes from './routes/invitations.js';
import gradingRoutes from './routes/grading.js';
import adminGroupsRoutes from './routes/admin-groups.js';
import groupsPublicRoutes from './routes/groups-public.js';
...
app.use('/api/custom-prep', customPrepRoutes);
app.use('/api/enrollment', enrollmentRoutes);
app.use('/api/invitations', invitationsRoutes);
app.use('/api/grading', gradingRoutes);
app.use('/api/admin', adminGroupsRoutes);
app.use('/api/groups', groupsPublicRoutes);
