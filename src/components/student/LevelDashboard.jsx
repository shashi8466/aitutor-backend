    ...
    <div className="min-h-screen bg-[#FAFAFA] pb-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          <div className="w-16 h-16 bg-[#5B42F3] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-indigo-200">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto font-medium text-sm sm:text-base">
        ...
        <div className="mb-10">
          <h3 className="text-xl font-bold text-[#1E1B4B] mb-4 flex items-center gap-2">
            <SafeIcon icon={FiFileText} className="w-5 h-5 text-[#5B42F3]" /> Study Materials
          </h3>
