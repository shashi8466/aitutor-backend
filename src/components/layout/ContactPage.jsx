...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030711] text-white selection:bg-sky-500/30 selection:text-sky-400 pt-48 sm:pt-56 pb-12 px-4 sm:px-6 lg:px-8 flex flex-col justify-center relative overflow-hidden">
      {/* Background Decor */}
